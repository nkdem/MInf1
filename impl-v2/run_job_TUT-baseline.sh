...
# Configuration
USER="s2203859"
SESSION_NAME="TUT-baseline"
WORK_DIR="/home/${USER}/minf-1"  # Working directory
TUT_ROOT_DIR="/home/s2203859/TUT-acoustic-scenes-2017-development"
TUT_DOWNSAMPLED_DIR="/home/s2203859/TUT-acoustic-scenes-2017-development-16k"
...
tmux send-keys -t $SESSION_NAME:0.0 "cp -r ${TUT_ROOT_DIR} ${SCRATCH_DIR}" C-m
tmux send-keys -t $SESSION_NAME:0.0 "cp -r ${TUT_DOWNSAMPLED_DIR} ${SCRATCH_DIR}" C-m
...
tmux send-keys -t $SESSION_NAME:0.0 "bash tut-baseline.sh ${EXPERIMENT_COUNT}" C-m
