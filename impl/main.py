...
def run_experiment(num_epochs, batch_size, number_of_experiments, max_lr=None, learning_rates=None, cuda=False):
    experiment_name = f'{num_epochs}_epochs_{batch_size}_batch_refactor_fixed'
...
if __name__ == '__main__':
    ...
    run_experiment(num_epochs=240, batch_size=16, number_of_experiments=5, learning_rates=[0.05,0.01, 0.001, 0.0005, 0.0002, 0.0001], cuda=cuda)