...
Otherwise, the approach remains the same: using the CHiME 3 dataset (see Section \ref{sec:chime3}) to blend the speech signal with background noise.
...
Table \ref{tab:chime3-stats} shows that the CHiME 3 dataset includes four speakers with an equal gender split, 
...
\subsection{CHiME3}
 As mentioned earlier, the researchers used the CHiME 3 dataset to mix the speech signal with the background noise. 
