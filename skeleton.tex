...
Operations Per Second to accommmodate its neural network with 4.5 million parameters [TODO: Cite].  Contrast this with a paper 
...
genetic abnormalities, infection, diseases or extrinistic factors such as exposure to loud noises.
...
does not need to be any surgical operations done. It is enough 
...
common to use 16 bits as it can represent an amplitude range of 96.34dB.

\subsubsection{Engineered Acoustic Features}
The prevalance of engineering acoustic features in previous work relating to my project warrants a high level 
overview of this concept to better understand its usage... 
TODO: Will write this in more detail once I cover this in the Speech Processing course (Week 7-8).

\section{Acoustic Scene Analysis (ASA)}
Acoustic Scene Analysis (ASA) is the process of classifying the environment of an audio sample. 
