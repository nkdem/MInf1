...
\begin{itemize}  
   ...
   \item \textbf{Chapter \ref{chap:asa-experiments} + \ref{chap:se-experiments}} - This chapter will cover the experiments conducted to validate the hypotheses established in Chapter \ref{chap:experimental_setup}.
...
\subsection{Speech Enhancement}
Although the \heards dataset has not been previously employed 
...
aware of the potential of the model in such contexts. But 
...
have begun reporting floating point operations (FLOPs) as a measure of model complexity,
...
none of these studies compare the model FLOPs to the computational capacity 
