...
\begin{figure}[h]
   ...
   \caption{The baseline model architecture. $B$ is the batch size, and $N$ is the number of classes/environments.
...
% \begin{figure}[h]
%    \centering
%    \includegraphics[width=0.9\textwidth]{speech-enhancement-model-architecture.png}
