...
show the spectrograms of the noisy, clean and enhanced speech signals for the Reverberant Environment, Wind Turbulence, Music and In Vehicle environments respectively.
...
\FloatBarrier
\begin{figure}[h]
    \caption{Spectrograms of the noisy, clean and enhanced speech signals.}
    \centering
    \hspace{0pt}%
    \begin{subfigure}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rev-spec.png}
        \caption{Reverberant Environment}
        \label{fig:rev-spec}
    \end{subfigure}%
